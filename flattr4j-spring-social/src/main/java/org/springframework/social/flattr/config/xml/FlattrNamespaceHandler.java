...
/**
 * {@link NamespaceHandler} for Flattr module to create configuration namespaces.
 *
 * @author Richard "Shred" Körber
 * @since 2.8
 */
public class FlattrNamespaceHandler extends AbstractProviderConfigNamespaceHandler {

    @Override
    protected AbstractProviderConfigBeanDefinitionParser getProviderConfigBeanDefinitionParser() {
        return new FlattrConfigBeanDefinitionParser();
    }
